...
@Autonomous(name="Red Place Far")
public class Red_Place_Far extends LinearOpMode {
...
//        }
        ...
        encoderTurn(TURN_SPEED,  94,  1, 500);
        encoderDrive(DRIVE_SPEED,  82,  82,1, 500);
        encoderTurn(TURN_SPEED,  -90,  -1, 500);
        encoderDrive(DRIVE_SPEED,  18,  18,1, 500);
        encoderTurn(TURN_SPEED,  90,  1, 500);
//        encoderTurn(TURN_SPEED,  90,  1, 500);
