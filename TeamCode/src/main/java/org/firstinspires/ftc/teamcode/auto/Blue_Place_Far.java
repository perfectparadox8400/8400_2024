...
@Autonomous(name="Blue Place Far")
public class Blue_Place_Far extends LinearOpMode {
...
//        }
        ...
        encoderDrive(DRIVE_SPEED,  3,  3,1, 500);
        encoderTurn(TURN_SPEED,  -97,  -1, 500);
        encoderDrive(DRIVE_SPEED,  83,  83,1, 500);
        encoderTurn(TURN_SPEED,  90,  1, 500);
        encoderDrive(DRIVE_SPEED,  20,  20,1, 500);
        encoderTurn(TURN_SPEED,  -90,  -1, 500);
//        encoderTurn(TURN_SPEED,  90,  1, 500);
