...
//import org.firstinspires.ftc.teamcode.auto.blue;
...
@Autonomous(name="Blue Long", group = "Old Auto")
public class Blue_Forward_Long extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (!isStarted() && !isStopRequested()){
            //boxlocation = blue.CubeDetectionPipeline.getAnalysis();
        ...
        if (opModeIsActive()) {
            ...
            } else if (Objects.equals(boxlocation, "LEFT")){
                encoderDrive(DRIVE_SPEED,  20,  20, 250);
                encoderDrive(TURN_SPEED,   -18, 17, 500);
                encoderDrive(DRIVE_SPEED,  4,  4, 500);
                encoderDrive(DRIVE_SPEED,  -85,  -85, 500);
            } else if (Objects.equals(boxlocation, "RIGHT")){
                encoderDrive(DRIVE_SPEED,  20,  20, 250);
                encoderDrive(TURN_SPEED,   17, -18, 500);
                encoderDrive(DRIVE_SPEED,  4,  4, 500);
                encoderDrive(DRIVE_SPEED,  -4,  -4, 500);
